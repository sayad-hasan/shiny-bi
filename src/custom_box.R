...
render_my_box <- function(value = "value", subtitle = "subtitle", bgcolor = "#faedcd", icon = NULL, textcolor = "black", padding = "10px" ) {
    tagList(
        
        div(class = paste0("small-box bg-", "custom"), style = glue("text-align: center!important; padding: {padding}!important; background: {bgcolor}!important; color: {textcolor};
