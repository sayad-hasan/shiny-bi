...
output$total_policy_count <- renderUI({
  ...
  render_my_box(value = format(totalpolicycount, big.mark = ",", scientific = F), subtitle = sub,
...
output$total_expired_policy_count <- renderUI({
  ...
  render_my_box(value = format(totalexpired, big.mark = ",", scientific = F), subtitle = sub,
...
output$total_cancelled_policy_count <- renderUI({
  ...
  render_my_box(value = format(totalcancelled, big.mark = ",", scientific = F), subtitle = sub,
...
output$barchart_monthly_policycount <- renderHighchart({
  ...
  hchart(total_by_month,
    'column', hcaes(x = month_p, y = total, color = month_p), name = "Policy"
  ) %>%
    hc_plotOptions(
      column = list(
        dataLabels = list(
    ...
    hc_exporting(
      ...
      filename = paste("Month wise Policy Issued", input$selectyear_1.5)
    )
...
output$barchart_yearly_policycount <- renderHighchart({
  ...
  hchart(total_by_year,
    'column', hcaes(x = year_p, y = total, color = total), name = "Policy"
  ) %>%
    hc_plotOptions(
      column = list(
        dataLabels = list(
    ...
    hc_exporting(
      enabled = TRUE, # always enabled
      filename = paste("Year wise Policy Issued")
    )
...
output$linechart_day <- renderHighchart({
  ...
  hchart(data,
         'line', hcaes(x = mrdate, y = total, color = total), name = "Net Premium"
  ) %>%
    hc_plotOptions(
      column = list(
        dataLabels = list(
    ...
    hc_exporting(
      enabled = TRUE, # always enabled
      filename = paste0("Daywise Net Premium Collection",input$daterange_2[1], "to", input$daterange_2[2])
    )
...
output$linechart_policycount <- renderHighchart({
  ...
  hchart(data,
         'line', hcaes(x = policyissuedate, y = total, color = total) , name = "Policy"
         ) %>%
    hc_plotOptions(
      column = list(
        dataLabels = list(
    ...
    hc_exporting(
      enabled = TRUE, # always enabled
      filename = paste("Daily Issued Total Poilcy Count", input$daterange_1.2[1], "to", input$daterange_1.2[2])
    )
})
...
output$linechart_month <- renderHighchart({
  ...
  hchart(totalprem_by_month,
    'column', hcaes(x = month_r, y = total, color = total), name = "Net Premium"
  ) %>%
    hc_plotOptions(
      column = list(
        dataLabels = list(
    ...
    hc_exporting(
      enabled = TRUE, # always enabled
      filename = paste("Month wise Net Premium Collection", input$selectyear_p)
    )
...
output$linechart_year <- renderHighchart({
  ...
  hchart(totalprem_by_year,
    'column', hcaes(x = year_r, y = total, color = year_r), name = "Net Premium"
  ) %>%
    hc_plotOptions(
      column = list(
        dataLabels = list(
    ...
    hc_exporting(
      enabled = TRUE, # always enabled
      filename = "Year wise Net Premium Collection"
    )
...
#   
#   render_my_box(value = format(totalbankdep, big.mark = ",", scientific = F), subtitle = sub,
...
output$valid_mobile_number <- renderUI({
  ...
  render_my_box(value = format(totalvalidmobile, big.mark = ",", scientific = F), subtitle = sub,
...
output$valid_email_address <- renderUI({
  ...
  render_my_box(value = format(totalvalidemail, big.mark = ",", scientific = F), subtitle = sub,
...
output$policydate_vs_number_value <- renderUI({
  ...
  render_my_box(value = format(t, big.mark = ",", scientific = F), subtitle = sub,
...
# all_insurancetypedata_reactive <- reactive({
#   insurancetype_sum_bar %>%
...
output$insurancetypepiechart <- renderHighchart({
  ...
  if(input$selectinput == "All"){
    ...
    # insurancetypedata <- all_insurancetypedata_reactive()
  ...
  hchart(insurancetypedata,
    ...
    hc_exporting(
      enabled = TRUE, # always enabled
      filename = paste("Class of insurance report")
    )
...
output$policycovercount_download <- downloadHandler(
  filename = function() {
    
    if(input$selectinput == "All"){
      paste("All Insurer class of insurance report", ".xlsx")
    }
    else {
      paste(input$selectinput,"class of insurance report" , ".xlsx")
    }
  ...
  content = function(file) {
    ...
    if(input$selectinput == "All"){
      ...
      insurancetypedata <- insurancetype_sum_bar %>%
        group_by(year_p, company_name, insurancetype) %>%
        summarise(counts = sum(counts, na.rm = T)) %>% mutate(percentage = round(prop.table(counts), 2)) %>%
        rename(
          "year" = "year_p",
          "total" = "counts",
      ...
      insurancetypedata <- split(insurancetypedata, f = insurancetypedata$year )
      
      writexl::write_xlsx(insurancetypedata, file)
    }
    else {
      insurancetypedata <- insurancetype_sum_bar %>%
        filter(company_name == input$selectinput) %>%
...
output$linechart_e_receipt <- renderHighchart({
  ...
  hchart(data,
    'line', hcaes(x = mrdate, y = total, color = total), name = "E-Receipt"
  ) %>%
    hc_plotOptions(
      column = list(
        dataLabels = list(
    ...
    hc_exporting(
      enabled = TRUE, # always enabled
      filename = paste("Total E-Receipt Issued Per Day", input$daterange_e_receipt[1], "to", input$daterange_e_receipt[2])
    )
...
output$monthlychart_e_receipt <- renderHighchart({
  ...
  hchart(total_by_month,
    'column', hcaes(x = month_r, y = total, color = month_r), name = "E-Receipt"
  ) %>%
    hc_plotOptions(
      column = list(
        dataLabels = list(
    ...
    hc_exporting(
      enabled = TRUE, # always enabled
      filename = paste("Total E-Receipt Issued Per Month", input$selectyear_e_receipt)
    )
...
output$yearlychart_e_receipt <- renderHighchart({
  ...
  hchart(total_by_month,
    'column', hcaes(x = year_r, y = total, color = year_r), name = "E-Receipt"
  ) %>%
    hc_plotOptions(
      column = list(
        dataLabels = list(
    ...
    hc_exporting(
      enabled = TRUE, # always enabled
      filename = paste("Total E-Receipt Issued Per Year")
    )
