...
nonlife_admin_sidebar <- list(
    ...
    selectInput("selectinput", "Branch", choices = nonlife_select_options, selected = "All"),
    sidebarMenu( id = "tabs",
        ...
        menuItem("Class of Insurance Report", tabName = "policycovercount", icon = icon("th")),
        ...
        menuItem("Data Anomalies Report", tabName = "analyticalcomparison", icon = icon("th"))
    ...
    tabItems(
        ...
        tabItem(
            ...
            fluidRow(
              ...
              box(
                ...
                dateRangeInput("daterange_1.2", "Choose a Date Range", "2021-01-01", today() ),
                width = 12
              ),
        ...
        tabItem( 
            ...
            fluidRow(
                ...
                box(
                    ...
                    dateRangeInput("daterange_2", "Chose a Date Range", "2021-01-01", today() ),
                    width = 12),
        ...
        tabItem(
            ...
            fluidRow(
                ...
                box(
                    status = "warning", solidHeader = TRUE, title = "Choose a date range",
                    dateRangeInput("daterange_e_receipt", "Choose a Date Range","2021-01-01",today() ),
                    width = 12),
        ...
        tabItem(
            ...
            fluidRow(
              ...
              # column(6, uiOutput("bank_deposited_policy")),
              column(6, uiOutput("valid_mobile_number")),
              column(6, uiOutput("valid_email_address")),
              column(6, uiOutput("policydate_vs_number_value")),
              column(6, uiOutput("covernote_present_policy_absent")),
              # column(6, uiOutput("covernote_policy_both_present")),
                ...
                #   dateRangeInput("daterange_insurancetype_dt", "Choose a date range","2021-01-01",today()),
                #   DTOutput("insurancetype_dt"),
                #   width = 12),
                
                # box(
                #     dateRangeInput("daterange_3.2", "Choose a date range","2021-01-01",today() ),
                #     width = 12),
                # 
                # box(
        ...
        tabItem(
            ...
            box(
                title = "Class of insurance report", status = "primary", solidHeader = TRUE,
            ...
            #            downloadButton("policycovercount_download", style = "padding: 10px", label = "Download Report")
            #        )
            # )
